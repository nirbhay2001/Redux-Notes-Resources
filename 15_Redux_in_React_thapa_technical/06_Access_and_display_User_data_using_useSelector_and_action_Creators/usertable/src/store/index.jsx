...
const store = configureStore({
    reducer: {
        users: userSlice, // eske help se userSlice ke sara data users me store ho jayega , jab bhi data ko display kar wana ho to hum users ki help se karwa sakte hai
    }
});
...
export default store; // eske help se store me store data ko aur dusre page me use kar sakte hai